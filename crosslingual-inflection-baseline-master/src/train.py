...
def get_args():
    ...
    parser.add_argument('--train', default=["../sample/hebrew--syriac/hebrew-train-high", "../sample/hebrew--syriac/classical-syriac-train-low"], nargs='+')
  #   parser.add_argument('--train', default=["../sample/hebrew--syriac/classical-syriac-train-low", "../sample/hebrew--syriac/classical-syriac-train-low"], nargs='+')
    ...
    parser.add_argument('--dev', default="../sample/hebrew--syriac/classical-syriac-dev")
    # parser.add_argument('--dev', default="sample/adyghe--kabardian/kabardian-dev",required=True)
    parser.add_argument('--test', default=None, type=str)
    parser.add_argument('--model', default="model/sigmorphon19/task1/tag-soft/hebrew--syriac", help='dump model filename')
